...
$(function () {
    blogEditor = editormd("blog-editormd", {
        ...
        imageUploadURL: "/admin/blog/upload/file",
...
$('#confirmButton').click(function () {
    ...
    var blogAccessUrl = $('#blogAccessUrl').val();
    ...
    if (!validLength(blogAccessUrl, 150)) {
        swal("路径过长", {
            icon: "error",
        });
        return;
...
$('#saveButton').click(function () {
    var blogPrimaryId = $('#blogPrimaryId').val();
    var blogTitle = $('#blogName').val();
    var blogAccessUrl = $('#blogAccessUrl').val();
    var blogCategoryId = $('#blogCategoryId').val();
    var blogTags = $('#blogTags').val();
    ...
    str = str.substring(0,index + 1) + window.location.port;
    blogCoverImage = blogCoverImage.replace(str,'');
    var url = '/admin/blog/save';
    var swlMessage = '保存成功';
    var data = {
        "blogTitle": blogTitle, "blogAccessUrl": blogAccessUrl, "blogCategoryId": blogCategoryId,
